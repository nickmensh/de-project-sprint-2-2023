...
DROP TABLE IF EXISTS dwh.tmp_sources; -- IDE не даёт создать TEMP таблицу и использовать её в дальнейших запросах, поэтому использую временные таблицы в основной схеме, а в конце переноса удаляю их
